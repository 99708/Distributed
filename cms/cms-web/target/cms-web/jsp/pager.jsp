<%@page import="org.xyq.basic.model.SystemContext"%>
...
<pg:pager export="curPage=pageNumber" 
	...
	maxPageItems="<%=SystemContext.getPagersize() %>"
	url="${param.url }">
	<span style="float:right;padding:6px;">
	共
	<pg:last>
		${pageNumber } 页[${param.totalRecord }条记录],每页显示<%=SystemContext.getPagersize() %>条,
	</pg:last>
