...
public class EnumUtils {
	...
	/**
	 * 将枚举的某个属性转换序数和字符串的map
	 * @param clz
	 * @param propName某个属性名称
	 * @return
	 */
	public static Map<Integer,String> enumProp2BasicMap(Class <? extends Enum> clz, String propName){
		if(!clz.isEnum()) return null;
		try {
			Enum[] enums = clz.getEnumConstants();
			Map<Integer,String> rels = new HashMap<Integer, String>();
	...
	/**
	 * 将枚举中的两个属性转换为序号和字符串map
	 * @param clz
	 * @param keyProp要转换的key属性
	 * @param valueProp要转换的value属性
	 * @return
	 */
